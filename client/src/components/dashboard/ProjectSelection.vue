<template>
  <div class="mb-3 mt-2">
    ...
    <span
      class="badge mr-2"
      v-if="!isEditing"
      style="font-size: 14px; background-color: #AE98D6; color: white; cursor:pointer;"
    >
      <i class="fas fa-plus p-1" @click="createProject"></i>
    </span>
    <span class="badge badge-dark mr-2" v-if="!isEditing" style="font-size: 14px; background-color: #fff589; color: white; cursor:pointer;">
      <i class="fas fa-pen p-1" @click="isEditing = true"></i>
    </span>
    <span class="badge " style="font-size: 14px; background-color: #DE1E1E; color: white; cursor:pointer;">
